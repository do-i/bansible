...
OS=$(uname)
DEVICE_NAME="${1}"
RASPBIAN="2017-07-05-raspbian-jessie-lite"

RASPBIAN_URL="http://downloads.raspberrypi.org/raspbian_lite/images/raspbian_lite-2017-07-05/2017-07-05-raspbian-jessie-lite.zip"
WORK_DIR=$(pwd)
